...
class DataProcessor:
    ...
    def process_data(self, data):
        ...
        pressure_data[17] = data[17] * 6894.76 / 5
        pressure_data[18] = data[18] * 6894.76 / 5
        pressure_data[19] = data[19] * 6894.76 / 5
        pressure_data[20] = data[20] * 6894.76 / 5
        pressure_data[21] = data[21] * 6894.76 / 5
