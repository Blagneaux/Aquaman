class Sensor extends Body {
    ...
    Sensor(float x, float y, int chord, Window window) {
        ...
        add(xc.x+15.5*chord/16-241*res/len,xc.y);
        ...
        //sensor 1 first side
        add(xc.x+15.5*chord/16-242*res/len,xc.y);

        // add(xc.x+chord,xc.y);
        // add(xc.x+chord,xc.y+2);

        //sensor 1 scd side
        add(xc.x+15.5*chord/16-242*res/len,xc.y+56*res/len);
        ...
        add(xc.x+15.5*chord/16-241*res/len,xc.y+56*res/len);
        end();
    }
}