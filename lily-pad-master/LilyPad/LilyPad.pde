...
//float Re = 1000;     // Reynolds number
//float origin = _L;      //mean position
...
//  output = createWriter("chinaBenchmark/Motion.csv");        // open output file
//  output2 = createWriter("chinaBenchmark/AfterMotion.csv");        // open output file
//  outputFullMap = createWriter("chinaBenchmark/FullMap.csv");
//  dat = new SaveData("chinaBenchmark/pressureMotion.txt",circle.coords,(int)L,2*n,n,1);    // initialize the output data file with header information
//  dat2 = new SaveData("chinaBenchmark/pressureAfterMotion.txt",circle.coords,(int)L,2*n,n,1);    // initialize the output data file with header information
//}
//void draw(){
//  if (flow.QUICK) {
//            dt = flow.checkCFL();
...
//    flow.update(circle); flow.update2();
...
//    }
//    dat.output.println("");
//    fill(0); text("posX = " + posX,width/2,height-30); text("posY = " + Ay*sin(2*PI*Fy*t),width/2,height-60);
